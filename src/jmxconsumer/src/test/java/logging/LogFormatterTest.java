...
public class LogFormatterTest {
    ...
    public void formatOutputsCorrectFieldOrder() {
        ...
        assertThat(fields[2]).isEqualTo("jmx_consumer");
    ...
    public void formatExtensions() {
        ...
        String expected = String.format("rt=%d requestMethod=%s suser=%s cs1Label=userAuthenticationMechanism cs1=Java Security Manager request=%s cs2Label=result cs2=%s cs3Label=reason cs3=%s dproc=jmx_consumer dst=%s",
